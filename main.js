...
const agents = {
  deployment_UU9y1Z4Z85RAPGwkss1mUUiZ: "Kite AI Assistant",
  deployment_ECz5O55dH0dBQaGKuT47kzYC: "Crypto Price Assistant",
...
async function sendRandomQuestion(agent, axiosInstance) {
  try {
    ...
    const randomQuestions = Object.values(questions).flat();
